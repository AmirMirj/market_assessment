...
function buildAssessment(input) {
  ...
  return {
    ...
    kpis: {
      ...
      category_leads: `${String(benchmark.categoryLeads).padStart(2, '0')}/${String(dimensions.length).padStart(2, '0')}`,
      market_momentum: signals.marketMomentum,
    },
    scores: {
      tech_leadership: entity.scores.tech_leadership || entity.scores.techLeadership,
      market_share: entity.scores.market_share || entity.scores.marketShare,
      software_integration: round(0.6 * entity.scores.factors.adaptiveControl + 0.4 * entity.scores.factors.cadCam),
    ...
    benchmark: {
      dimensions,
      series: [
        {name: entity.name, color: entity.color, values: entity.scores.benchmark, primary: true},
        ...peers,
      ],
...
module.exports = {buildAssessment, resolveEntity};
